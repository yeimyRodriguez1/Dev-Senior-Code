...
public class App {
        public static void main(String[] args) {
                ...
                System.out.println(
                                test1.getNombre() + "promedio" + test1.getPromedio() + "calificacion: "
                                                + test1.obtenerCalificacion());
                System.out.println(
                                test2.getNombre() + "promedio" + test2.getPromedio() + "calificacion: "
                                                + test2.obtenerCalificacion());
                System.out.println(
                                test3.getNombre() + "promedio" + test3.getPromedio() + "calificacion: "
                                                + test3.obtenerCalificacion());
                System.out.println(
                                test4.getNombre() + "promedio" + test4.getPromedio() + "calificacion: "
                                                + test4.obtenerCalificacion());
                System.out.println(
                                test5.getNombre() + "promedio" + test5.getPromedio() + "calificacion: "
